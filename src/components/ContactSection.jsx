...
export default function ContactSection() {
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 text-center">
          ...
          <FadeIn className="flex flex-col items-center gap-2">
            <div className="uppercase tracking-widest text-xs font-light mb-1" style={{ color: '#C99A2E' }}>Visit</div>
            <div className="font-medium leading-snug" style={{ color: '#F2EFE4', fontSize: 'clamp(0.95rem, 1.2vw, 1.15rem)' }}>
              83 Newport West Blvd<br />Kingston, Jamaica
            </div>
            <div className="uppercase tracking-widest text-xs font-light mt-4 mb-1" style={{ color: '#C99A2E' }}>Also At</div>
            <div className="font-medium leading-snug" style={{ color: '#F2EFE4', fontSize: 'clamp(0.95rem, 1.2vw, 1.15rem)' }}>
          ...
          {/* Call & Email */}
          <FadeIn delay={0.08} className="flex flex-col items-center gap-2">
            <div className="uppercase tracking-widest text-xs font-light mb-1" style={{ color: '#C99A2E' }}>Call</div>
            <div className="font-medium leading-snug" style={{ color: '#F2EFE4', fontSize: 'clamp(0.95rem, 1.2vw, 1.15rem)' }}>
              +1 876 335 6934<br />+1 876 757 4835
            </div>
            <div className="uppercase tracking-widest text-xs font-light mt-4 mb-1" style={{ color: '#C99A2E' }}>Email</div>
            <a
          ...
          {/* Hours & Social */}
          <FadeIn delay={0.16} className="flex flex-col items-center gap-2">
            <div className="uppercase tracking-widest text-xs font-light mb-1" style={{ color: '#C99A2E' }}>Hours</div>
            <div className="font-medium leading-snug" style={{ color: '#F2EFE4', fontSize: 'clamp(0.95rem, 1.2vw, 1.15rem)' }}>
              Mon – Sat · 8:30 AM – 4:30 PM<br />Sunday · Closed
            </div>
            <div className="uppercase tracking-widest text-xs font-light mt-4 mb-1" style={{ color: '#C99A2E' }}>Social</div>
      ...
      {/* Footer bar */}
      <footer
        className="max-w-5xl mx-auto mt-20 md:mt-24 pt-8 flex flex-col md:flex-row items-center justify-between gap-4"
        style={{ borderTop: '1px solid rgba(242,239,228,0.15)' }}
      >
        <div
          className="uppercase tracking-widest font-light text-xs text-center md:text-left"
          style={{ color: '#F2EFE4aa' }}
        >
          © 2026 Fresh &amp; Direct Ltd. · All Rights Reserved
        </div>
        <div
          className="uppercase tracking-widest font-light text-xs text-center md:text-right"
          style={{ color: '#F2EFE4aa' }}
        >
